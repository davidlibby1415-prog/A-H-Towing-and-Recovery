...
/**
 * TikTok embed in a phone-style frame with a tight crop on the actual video.
 *
 * Usage:
 *   <TikTokEmbed videoId="7512230159630617887" title="Commercial Tow: The Flying School Bus" />
 *   <TikTokEmbed url="https://www.tiktok.com/@285302ditchking/video/7512230159630617887" />
 */

function buildEmbedSrc({ videoId, url }) {
  // If explicit embed URL is provided and already uses /embed/, trust it.
  if (url && url.includes("/embed/")) {
    return url;
  }

  // Try to pull an ID out of a normal TikTok URL:
  // e.g. https://www.tiktok.com/@user/video/7512230159630617887
  if (url && !videoId) {
...
export function TikTokEmbed({
  videoId = "7541454523265535245", // default fallback video
  url,
