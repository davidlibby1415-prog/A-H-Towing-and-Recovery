  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-neutral-950">
        <BrandHero
          heroVideoSrc="/Videos/fuel.mp4"   // <-- capital V (correct path)
          poster="/fallback.jpg"
          ...
          bannerTopMarginPx={0}
          cardCenterOffsetPx={8}     // move card UP toward your yellow line
          overlayOpacity={0.25}
        />

        {/* Description + Safety tips with vibrant borders & shaded panels */}
