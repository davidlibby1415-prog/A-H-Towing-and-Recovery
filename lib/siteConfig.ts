...
export const siteConfig = {
  ...
  phone: process.env.NEXT_PUBLIC_PHONE || "(432) 000-0000", // set in .env.local as NEXT_PUBLIC_PHONE
  phoneHref: `tel:${(process.env.NEXT_PUBLIC_PHONE || "4320000000").replace(/[^\d+]/g, "")}`,
