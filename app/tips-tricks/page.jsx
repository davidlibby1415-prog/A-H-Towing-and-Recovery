        ...
        <section className="py-10 bg-neutral-950">
          <div className="container max-w-7xl space-y-10">
            <TikTokSection
              ...
              subtitle="Short clips that help new and experienced drivers see how we handle air, brakes, and no-key situations."
              videos={professionalVideos}
            />

            <TikTokSection
              title="Training: Team Practice w/ 1st Responders"
              subtitle="Behind-the-scenes looks at practice days, teamwork, and moving heavy loads safely."
              videos={trainingVideos}
            />

            <TikTokSection
              title="Safety Eye Openers"
              subtitle="Real West Texas conditions — sand storms, night work, and close calls — that show why we take safety so seriously."
              videos={safetyVideos}
            />
          </div>
        </section>
