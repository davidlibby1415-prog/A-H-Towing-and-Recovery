...
// Safe gradient border (no styled-jsx)
          ...
          <div className="grid gap-8 md:grid-cols-2 items-start">
            ...
            <SteelPanel>
              <Bubble className="!bg-black/65 mb-4">
                <span className="text-[15px] md:text-lg font-extrabold">Meet the Owners</span>
              </Bubble>
              ...
              <p className="text-sm md:text-base text-slate-100/90 leading-relaxed mb-3">
                ...
                <span className="font-bold text-amber-300">woman-led, family-owned</span> towing and
                recovery company based in Pecos, Texas. The business is owned by a husband-and-wife
                team, with <span className="font-semibold">the wife leading the company</span> as the
                primary decision-maker and face of the operation.
              </p>

              <p className="text-sm md:text-base text-slate-100/90 leading-relaxed mb-3">
                Together, they built A &amp; H around <span className="font-semibold">simple values</span>:
                show up fast, treat people right, and handle every vehicle with the same care they&apos;d
                want for their own family. From stranded travelers on I-20 to oilfield crews out on lease
                roads, they focus on keeping drivers safe and equipment moving.
              </p>

              <p className="text-sm md:text-base text-slate-100/90 leading-relaxed mb-3">
                As a <span className="font-semibold">woman-led towing company</span>, A &amp; H brings a
                professional, organized, and relationship-focused approach to every call — whether
                it&apos;s a single vehicle tow or ongoing work with fleets and oilfield partners.
              </p>

              <p className="text-sm md:text-base text-slate-100/90 leading-relaxed">
                When you call A &amp; H Towing &amp; Recovery, you&apos;re not just getting a truck.
                You&apos;re working directly with the owners — people who live here, work here, and
                stand behind every job with their family name.
              </p>
            </SteelPanel>
            ...
            <div className="space-y-4">
              <SteelPanel className="flex flex-col gap-4">
                <Bubble className="!bg-black/65 mb-1">
                  <span className="text-[14px] md:text-base font-extrabold">Owners</span>
                </Bubble>
                ...
                <p className="text-xs md:text-sm text-slate-100/80 leading-relaxed">
                  Photos: Husband-and-wife ownership team of A &amp; H Towing &amp; Recovery, serving
                  Pecos and the surrounding West Texas region.
                </p>
              </SteelPanel>

              <SteelPanel>
                <h2 className="text-lg md:text-xl font-extrabold mb-2">Why Woman-Led Matters</h2>
                <p className="text-sm md:text-base text-slate-100/90 leading-relaxed mb-2">
                  Being woman-led is more than a label — it shows up in how A &amp; H handles
                  communication, timing, and follow-through. Details matter. Safety matters. Clear
                  updates matter.
                </p>
                <p className="text-sm md:text-base text-slate-100/90 leading-relaxed">
                  From first call to final drop-off, you can expect{" "}
                  <span className="font-semibold">professional dispatch, clear expectations, and
                  respectful service</span> for drivers, families, and crews.
                </p>
              </SteelPanel>
            </div>
          </div>
